...
public class final_instrument_patient extends AppCompatActivity {
    public final static String PAGINA_DEBUG = "final_instrument_patien";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_instrument_patient);
    ...
    private void addReporte(String pregunta1, String pregunta2, String pregunta3, String pregunta4, String pregunta5, String pregunta6, String pregunta7, String pregunta8, String pregunta9) {
        ...
        class LoginAsync  extends AsyncTask<String, Void, JSONObject> {
            ...
            private final String url = "http://app.bluecoreservices.com/webservices/addEvalPaciente.php";
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(final_instrument_patient.this, "Please wait", "Loading...");
            }
